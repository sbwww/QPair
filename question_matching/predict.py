...
if __name__ == "__main__":
    ...
    if args.model_name_or_path and os.path.isfile(args.model_name_or_path):
        state_dict = paddle.load(args.model_name_or_path)
        model.set_dict(state_dict)
        print("Loaded parameters from %s" % args.model_name_or_path)
    else:
        raise ValueError(
